...
import { c as createExports, s as serverEntrypointModule } from './chunks/_@astrojs-ssr-adapter_B_W3gYrT.mjs';
import { manifest } from './manifest_Be0Ap-jE.mjs';
...
const _page4 = () => import('./pages/page/1.astro.mjs');
const _page5 = () => import('./pages/page/_page_.astro.mjs');
const _page6 = () => import('./pages/privacy.astro.mjs');
const _page7 = () => import('./pages/q/_slug_.astro.mjs');
const _page8 = () => import('./pages/questions.astro.mjs');
...
const pageMap = new Map([
    ...
    ["src/pages/page/1.astro", _page4],
    ["src/pages/page/[page].astro", _page5],
    ["src/pages/privacy.astro", _page6],
    ["src/pages/q/[slug].astro", _page7],
    ["src/pages/questions.astro", _page8],
...
const _args = {
    "middlewareSecret": "9518405c-d3d0-43bd-bc2b-5ef386014082",
