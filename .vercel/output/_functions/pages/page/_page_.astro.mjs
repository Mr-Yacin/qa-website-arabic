/* empty css                                    */
import { c as createComponent, a as createAstro, r as renderComponent, b as renderTemplate, m as maybeRenderHead, d as addAttribute, F as Fragment } from '../../chunks/astro/server_B_luCV0f.mjs';
import 'kleur/colors';
...
← السابق
</span>`} <!-- Page Numbers --> <div class="flex items-center space-x-1 space-x-reverse mx-4">  ${paginationResult.page > 3 && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": async ($$result3) => renderTemplate` <a href="/" class="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105" aria-label="الانتقال إلى الصفحة 1">
1
  ...
  ).filter((pageNum2) => pageNum2 <= paginationResult.page + 1 && pageNum2 >= paginationResult.page - 1).map((pageNum2) => pageNum2 === paginationResult.page ? renderTemplate`<span class="inline-flex items-center px-3 py-2 text-sm font-medium text-white bg-indigo-600 dark:bg-indigo-500 border border-indigo-600 dark:border-indigo-500 rounded-md" aria-current="page"> ${pageNum2} </span>` : renderTemplate`<a${addAttribute(pageNum2 === 1 ? "/" : `/page/${pageNum2}`, "href")} class="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105"${addAttribute(`\u0627\u0644\u0627\u0646\u062A\u0642\u0627\u0644 \u0625\u0644\u0649 \u0627\u0644\u0635\u0641\u062D\u0629 ${pageNum2}`, "aria-label")}> ${pageNum2} </a>`)}  ${paginationResult.page < paginationResult.pages - 2 && renderTemplate`${renderComponent($$result2, "Fragment", Fragment, {}, { "default": async ($$result3) => renderTemplate`${paginationResult.page < paginationResult.pages - 3 && renderTemplate`<span class="px-2 text-zinc-500 dark:text-zinc-400">...</span>`}<a${addAttribute(`/page/${paginationResult.pages}`, "href")} class="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105"${addAttribute(`\u0627\u0644\u0627\u0646\u062A\u0642\u0627\u0644 \u0625\u0644\u0649 \u0627\u0644\u0635\u0641\u062D\u0629 \u0627\u0644\u0623\u062E\u064A\u0631\u0629 ${paginationResult.pages}`, "aria-label")}> ${paginationResult.pages} </a> ` })}`} </div> <!-- Next Page Button --> ${paginationResult.hasNext ? renderTemplate`<a${addAttribute(`/page/${paginationResult.page + 1}`, "href")} class="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-500 dark:text-zinc-400 bg-white dark:bg-zinc-800 border border-zinc-300 dark:border-zinc-600 rounded-md hover:bg-zinc-50 dark:hover:bg-zinc-700 hover:text-zinc-700 dark:hover:text-zinc-300 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105" aria-label="الانتقال إلى الصفحة التالية">
التالي →
</a>` : renderTemplate`<span class="inline-flex items-center px-3 py-2 text-sm font-medium text-zinc-300 dark:text-zinc-600 bg-zinc-100 dark:bg-zinc-800 border border-zinc-200 dark:border-zinc-700 rounded-md cursor-not-allowed">
التالي →
</span>`} </div> </nav>`} <div class="mt-12 text-center"> <div class="flex flex-col sm:flex-row gap-4 justify-center"> <a href="/tags" class="inline-flex items-center justify-center px-6 py-3 border border-zinc-300 dark:border-zinc-600 text-base font-medium rounded-lg text-zinc-700 dark:text-zinc-300 bg-white dark:bg-zinc-800 hover:bg-zinc-50 dark:hover:bg-zinc-700 transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105">
تصفح حسب الموضوع
