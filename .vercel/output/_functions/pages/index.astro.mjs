/* empty css                                   */
import { c as createComponent, r as renderComponent, a as renderTemplate, m as maybeRenderHead, d as addAttribute } from '../chunks/astro/server_CoapMQ39.mjs';
import 'kleur/colors';
...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": title, "description": description }, { "default": async ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="text-center mb-12"> <div class="max-w-2xl mx-auto"> <h1 class="mx-auto max-w-3xl text-center font-extrabold
         text-[clamp(2rem,6vw,3.25rem)] leading-tight tracking-tight
         text-zinc-900 dark:text-zinc-100 mb-6">
مرحباً بك في موقع
<span class="bg-gradient-to-tr from-indigo-600 via-indigo-500 to-sky-500
           bg-clip-text text-transparent dark:from-indigo-400 dark:via-indigo-300 dark:to-sky-400">
الأسئلة والأجوبة
</span> </h1> <p class="text-lg md:text-xl text-zinc-600 dark:text-zinc-300 mb-8 leading-loose max-w-3xl mx-auto">
اكتشف إجابات شاملة ومفيدة لأسئلتك التقنية باللغة العربية. نقدم محتوى
        عالي الجودة يساعدك في رحلتك التعليمية والمهنية.
...
أحدث الأسئلة
</h2> <a href="/questions" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 font-medium rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105 text-sm"> <span>عرض الكل</span> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg> </a> </div> ${latestQuestions.length > 0 ? renderTemplate`<div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3"> ${latestQuestions.map((question) => renderTemplate`${renderComponent($$result2, "CardQuestion", $$CardQuestion, { "href": `/q/${question.slug}`, "title": question.data.question, "description": question.data.shortAnswer, "date": question.data.pubDate, "tags": question.data.tags, "difficulty": question.data.difficulty })}`)} </div>` : renderTemplate`<div class="text-center py-12"> <p class="text-zinc-500 dark:text-zinc-400 text-lg">
...
</p> </div>`} ${popularTags.length > 0 && renderTemplate`<div class="mt-6 text-center"> <a href="/tags" class="inline-flex items-center gap-2 px-4 py-2 bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 dark:hover:bg-indigo-900/50 font-medium rounded-lg transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-105 text-sm"> <span>عرض جميع المواضيع</span> <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path> </svg> </a> </div>`} </section>  <section class="text-center py-12 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-950/30 dark:to-purple-950/30 rounded-2xl border border-indigo-100 dark:border-indigo-800/50"> <div class="max-w-xl mx-auto px-6"> <h3 class="text-2xl font-bold text-zinc-900 dark:text-zinc-100 mb-4">
ابدأ رحلة التعلم الآن
</h3> <p class="text-zinc-600 dark:text-zinc-300 mb-6">
انضم إلى مجتمعنا واكتشف المزيد من الإجابات المفيدة والمحتوى التعليمي
        المتميز
</p> <div class="flex flex-col sm:flex-row gap-3 justify-center"> <a href="/questions" class="inline-flex items-center justify-center px-8 py-4 bg-indigo-600 hover:bg-indigo-700 dark:bg-indigo-500 dark:hover:bg-indigo-600 text-white font-semibold text-lg rounded-lg transition-all duration-200 shadow-xl hover:shadow-2xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 dark:focus-visible:ring-indigo-400 dark:focus-visible:ring-offset-zinc-950 hover:scale-110">
استكشف الأسئلة
